...
namespace dgm
{
    ...
    public:
        ...
        polarToCartesian(float angle, float size)
        {
            angle *= PIOVER180;
         ...
         */
        static [[nodiscard]] sf::Vector2f
        polarToCartesian(const sf::Vector2f& angleSize)
        {
         ...
         */
        static [[nodiscard]] sf::Vector2f
        cartesianToPolar(const float x, const float y);
         ...
         */
        static [[nodiscard]] sf::Vector2f
        cartesianToPolar(const sf::Vector2f& coordinates)
        {
